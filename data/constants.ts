...
// Updated icons to match official brand keys in Icons.tsx
export const SKILLS: Skill[] = [
  { name: "React / Next.js", level: 95, category: "frontend", icon: "react" },
  { name: "TypeScript", level: 90, category: "frontend", icon: "typescript" },
  { name: "Tailwind CSS", level: 95, category: "frontend", icon: "tailwind" },
  { name: "Node.js / Express", level: 85, category: "backend", icon: "nodejs" },
  { name: "MongoDB / SQL", level: 80, category: "backend", icon: "mongodb" },
  { name: "Gemini / AI", level: 85, category: "ai", icon: "gemini" },
  { name: "Docker / AWS", level: 70, category: "tools", icon: "docker" },
  { name: "Git / CI/CD", level: 85, category: "tools", icon: "git" },
];
